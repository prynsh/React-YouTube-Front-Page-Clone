...
export function PageHeader(){
    ...
    return (<div className="flex gap-10 lg:gap-20 justify-between pt-2 mb-6 mx-4">
        ...
        {showFullWidthSearch && (<Button onClick={()=>setshowFullWidthSearch(false)} type="button" size="icon" variant="ghost" className="flex felx-shrink-0">
                <ArrowLeft/>
            </Button>)}
            ...
            <Button type="button" size="icon" className="flex felx-shrink-0">
                <Mic/>
            </Button>
        </form>
